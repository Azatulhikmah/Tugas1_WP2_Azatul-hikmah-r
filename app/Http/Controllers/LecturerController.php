...
class LecturerController extends Controller
{
    ...
    {
        // membuat objek dosen dari class Lecturer yang mengambil seluruh data dan dibuat pagination, kemudian menuju view index dengan membawa data di objek $dosen
